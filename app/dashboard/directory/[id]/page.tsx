          ...
          <div className="flex-1">
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <span className={`text-xs px-3 py-1 font-light uppercase tracking-wide ${getTierBadgeColor(profile.tier)}`}>
                  {profile.tier} Member
                </span>
              </div>
              ...
              {!isOwnProfile && (
                <Link href={`/dashboard/messages/${profile.id}`}>
                  <button className="border border-amber-600 text-amber-600 px-6 py-2 text-sm font-light hover:bg-amber-600 hover:text-stone-950 transition-colors flex items-center gap-2">
              ...
              {isOwnProfile && (
                <Link href="/dashboard/settings">
                  <button className="border border-stone-700 text-stone-400 px-6 py-2 text-sm font-light hover:border-amber-600 hover:text-amber-600 transition-colors">
                    Edit Profile
                  </button>
                </Link>
              )}
            ...
            {projects.map(project => {
              ...
              return (
                <Link key={project.id} href={`/dashboard/the-pool/projects/${project.id}`}>
                  <div className="border border-stone-800 p-6 hover:border-amber-600 transition-colors cursor-pointer">
                    ...
                    <div className="w-full bg-stone-900 h-1 mt-3">
                      <div
